...
class DndPage extends StatefulWidget {
  static const routeName = '/dnd';

  @override
  _DndPageState createState() => _DndPageState();
}

class _DndPageState extends State<DndPage> with WidgetsBindingObserver {
  String _filterName = '';
      ...
      home: Scaffold(
        ...
        body: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
            ...
            Text('isNotificationPolicyAccessGranted: ${_isNotificationPolicyAccessGranted ? 'YES' : 'NO'}'),
            SizedBox(
              height: 10,
            ),
            RaisedButton(
